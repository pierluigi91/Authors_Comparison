...
def print_results(array):
    ...
    for idx, val in enumerate(array):
        temp_len = len(open('/home/pierluigi/PycharmProjects/Authors_Comparison/cnn-text-classification/data/input_backup/'+d['file_name'], "r").readlines())
...
def pred(entrada, label, seq_len, multiple_lines=False):
    with tf.Graph().as_default():
        ...
        with sess.as_default():
            ...
            #saver.restore(sess, "/home/pierluigi/PycharmProjects/Authors_Comparison/cnn-text-classification/runs/1464774069/checkpoints/model-5400")
            #saver.restore(sess, "/home/pierluigi/PycharmProjects/Authors_Comparison/cnn-text-classification/runs/1464950406/checkpoints/model-3900")
            saver.restore(sess, "/home/pierluigi/PycharmProjects/Authors_Comparison/cnn-text-classification/runs/1464964595/checkpoints/model-3900")
